...
If the id value is less then 700 using <a href = "https://www.twilio.com/">Twillio </a> a message is triggered to my personal phone. Giving a reminder message to carry a umberella that day.


Scheduled to run this script daily at 9:00 AM IST time using <a href = "https://www.pythonanywhere.com/">pythonanywhere </a>
